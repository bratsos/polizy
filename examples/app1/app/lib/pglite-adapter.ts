...
/** The single table every polizy adapter manages. Field-level ids like
 *  `doc-payroll#summary` are just normal `object_id` values — polizy's engine
 *  handles the `#field` inheritance, the storage layer stays dumb. */
